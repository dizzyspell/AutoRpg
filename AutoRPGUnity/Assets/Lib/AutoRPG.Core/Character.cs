...
namespace AutoRPG.Core
{
    ...
    public class Character : ICharacter
    {
        ...
        {
            var fMaxHeal = mrMaxHealthPoints - HealthPoints;
            var fAdjustedHeal = Math.Min(aBaseHeal, fMaxHeal);
        ...
        {
            var fAdjustedValue = aBaseDefense.Clamp(
        ...
        {
            var fName = aName ?? RandomNumberGod.ChooseName();
            var fClass = RandomNumberGod.ChooseClass();
            var fPersonality = RandomNumberGod.ChoosePersonality();
